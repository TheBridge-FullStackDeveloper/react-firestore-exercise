...
export function SongCard({ singleSong }) {
  ...
  //A mutation refers to an operation that directly modifies data

  const { mutate: mutateDeleteSong } = useMutation({
    mutationKey: "songs",
    mutationFn: deleteSong, //This specifies the function that actually performs the mutation.
    onSuccess: () => {
          ...
          <div className="flex flex-col col-span-6 md:col-span-8">
            <div className="flex justify-between items-start">
              ...
              <IconButton
                ...
                color="primary"
                onClick={() => {
                  mutateDeleteSong(singleSong.id);
                }}
              >
                <DeleteIcon />
              </IconButton>
